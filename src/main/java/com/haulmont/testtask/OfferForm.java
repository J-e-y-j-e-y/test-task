...
public class OfferForm extends FormLayout {
    ...
    public OfferForm(MainUI ui, CreditOfferController controller, ClientController clientController, CreditController creditController, BankController bankController, PaymentGraph paymentGraph){
        this.ui = ui;
        ...
        this.addComponents(client, credit, creditSum, months, layout, components);
